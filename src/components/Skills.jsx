  ...
  return (
   ...
   data-aos="fade-left"
       className="grid my-10 xl:grid-cols-5 grid-cols-2 sm:gap-10 md:grid-cols-3  gap-3  md:gap-20">
        {/* card */}
        <div  className=' rounded-lg p-2 py-3 bg-white/5 relative backdrop-blur-md border-sky-400 flex justify-center'>
        <img style={{ filter: "drop-shadow(1px 1px 3px #38BDF8)" }} className='p-2' width={'100px'} src={HTML} alt="" />
        </div>
        <div  className='  rounded-lg p-2 bg-white/5 relative backdrop-blur-md border-sky-400 flex justify-center'>
        ...
        <div  className=' rounded-lg p-2 bg-white/5 relative backdrop-blur-md border-sky-400 flex flex-col items-center justify-center'>
        ...
        <div  className=' rounded-lg p-2  bg-white/5 relative backdrop-blur-md border-sky-400 flex flex-col justify-center items-center text-center'>
        ...
        <div  className=' rounded-lg p-2  bg-white/5 relative backdrop-blur-md border-sky-400 flex flex-col justify-center items-center'>
        ...
        <h2 className='font-bolder md:text-2xl text-xl'>Angular</h2>
         ...
         <div  className=' rounded-lg p-2  bg-white/5 relative backdrop-blur-md border-sky-400 flex justify-center items-center'>
