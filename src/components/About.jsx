...
const About = () => {
  ...
  return (
    ...
    <>
      <div id='about' style={{background:'#0b1121'}} className=' bg-yellow-300 w-full px-10 md:px-40 pb-40 pt-10 '>
        <div
        
        data-aos="fade-right" className='grid gap-20  grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 text-justify  '>
          <div className=''>
            <h2 style={{color:"#4CC9FE"}} className='text-2xl mb-2'>01 Intro</h2>
            <a  className="font-bold cursor-none  text-3xl md:text-5xl my-3 py-2 relative  before:absolute before:bottom-0 before:left-0 before:w-0 before:h-[2px] before:bg-sky-400 before:transition-all before:duration-300 hover:before:w-full ">About</a>
          ...
          <div className="  flex justify-center items-center  ">
            <img className='w-8/12 ' src={GIF} alt="No Image is Available" />
          </div>
          </div>
